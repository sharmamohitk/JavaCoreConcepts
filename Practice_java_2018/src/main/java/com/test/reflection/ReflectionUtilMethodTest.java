...
public class ReflectionUtilMethodTest {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		// java.lang.Class is the entry point for all the reflection operations. For every type of object, 
		// JVM instantiates an immutable instance of java.lang.Class that provides methods to examine the 
		// runtime properties of the object and create new objects, invoke its method and get/set object fields
		//The required classes for reflection are provided under java.lang.reflect package.
        //Reflection gives us information about the class to which an object belongs and also the methods of that class which can be executed by using the object.
		//Through reflection we can invoke methods at runtime irrespective of the access specifier used with them.
		
		
		// We can get Class of an object using three methods – through static variable class, using getClass() method of object 
		// and java.lang.Class.forName(String fullyClassifiedClassName). For primitive types and arrays, we can use static variable class. 
